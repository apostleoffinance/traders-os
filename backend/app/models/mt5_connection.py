...
class Mt5Connection(Base):
    ...
    # EA reports DEAL_TIME/POSITION_TIME as broker server time mislabeled "Z" (UTC).
    # Derived each sync from sync_timestamp drift and subtracted to recover true UTC.
    broker_utc_offset_seconds: Mapped[int | None] = mapped_column(Integer, nullable=True)
